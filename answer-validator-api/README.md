# LEDGER answer-validator-api

> Repository-layout note: the runnable validator currently lives in the
> nested `answer-validator-api/` directory. The legacy processor files at this
> repository root are not part of the validator launch path.

Lightweight Windows setup from this repository root:

```powershell
python -m venv .venv
.venv\Scripts\python.exe -m pip install -r requirements.txt
.venv\Scripts\python.exe -m uvicorn --app-dir answer-validator-api main:app --host 0.0.0.0 --port 8006
.venv\Scripts\python.exe -m pytest answer-validator-api/tests -q
```

The validator requires no API key and downloads no ML models.

---

## Legacy duplicated processor documentation
