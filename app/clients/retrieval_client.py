...
async def call_retrieval_ingest(client: httpx.AsyncClient, ingest_payload: dict, trace_id: str) -> dict:
    """
    Calls retrieval-api's EXISTING POST /ingest endpoint (document
    ingestion/indexing).
    ...
    return await post_with_retry(client, url, ingest_payload, service_name="retrieval-api", trace_id=trace_id)
